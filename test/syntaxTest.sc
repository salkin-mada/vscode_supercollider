...
play{|pip=1e-3|Klang.ar(`[(_.linlog(0,2e4,99,1e4))!2e4,pip]).tanh!2}

2pi, 0.43, 0x123, 12e3, 3e-2
"strstr" ~tilde _that symbolArg: \symb 'symb' 
...
linlin loglin linlog min max round trunc atan2 hypot hypotApx ring1 ring2 ring3 
